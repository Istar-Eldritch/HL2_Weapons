class CfgPatches
{
	class VRP_HL2Weapons_StunBaton
	{
		units[] = {
			"HL2_StunBaton"
		};
...
class CfgMods
{
	class VRP_HL2Weapons_StunBaton
	{
		...
		class defs
		{
			...
			{
				value = "";
				files[] = {"VRP/HL2Weapons/HL2_StunBaton/scripts/4_World"};
			};
			class missionScriptModule
			{
				value = "";
				files[] = {"VRP/HL2Weapons/HL2_StunBaton/scripts/5_Mission"};
			};
		};
	};
};
...
class CfgVehicles
{
	...
	class HL2_StunBaton: Powered_Base
	{
		...
		model="\VRP\HL2Weapons\HL2_StunBaton\data\stunbaton.p3d";
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"VRP\HL2Weapons\HL2_StunBaton\data\stunbaton.rvmat"
							}
						},
						...
						
						{
							...
							{
								"VRP\HL2Weapons\HL2_StunBaton\data\stunbaton_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"VRP\HL2Weapons\HL2_StunBaton\data\stunbaton_destruct.rvmat"
							}
						}
					};
				};
